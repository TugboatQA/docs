...
* [Build Script Examples](examples/index.md)
  * [By Feature](examples/features/index.md)
    ...
    * [Change the Document Root Location](examples/features/change-docroot/index.md)
    * [Re-use a Common Set of Commands](examples/features/reuse-commands/index.md)
    * [Use External Scripts](examples/features/external-scripts/index.md)
    * [Run Functional Tests](examples/features/functional-tests/index.md)
  * [By Application](examples/applications/index.md)
  ...
  * [By Service](examples/services/index.md)
    * [Pantheon](examples/services/pantheon/index.md)
      * [1. Create a project](examples/services/pantheon/index.md#1.-create-a-tugboat-project)
      * [2. Add services](examples/services/pantheon/add-services/index.md)
      * [3. Configure terminus](examples/services/pantheon/configure-terminus/index.md)
