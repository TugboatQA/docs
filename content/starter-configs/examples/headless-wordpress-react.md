...
In this example, we assume that the frontend is located in a separate repo. In addition to this configuration, you will
need to
[use the Public SSH key that is on the Repository Settings page](/setting-up-tugboat/select-repo-settings/index.html#use-the-tugboat-ssh-key),
